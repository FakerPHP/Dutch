...
final class Person implements PersonExtension, GeneratorAwareExtension
{
    ...
    private string $maleNameFormat = '{{Faker\Dutch\BE\Person->firstNameMale}} {{Faker\Dutch\BE\Person->lastName}}';
    ...
    {
        return Helper::randomElement($this->firstNamesMale);
    }

    public function firstNameFemale(): string
    {
        return Helper::randomElement($this->firstNamesFemale);
    }
    ...
    {
        return Helper::randomElement($this->titlesMale);
    }

    public function titleFemale(): string
    {
        return Helper::randomElement($this->titlesFemale);
    }
