...
final class Person implements PersonExtension, GeneratorAwareExtension
{
    ...
    private array $titles = [
        'dr.', 'mr.', 'ir.', 'drs.', 'bacc.', 'kand.', 'dr.h.c.', 'prof.', 'ds.', 'ing.', 'bc.',
    ];
    ...
    private array $foreignLastNames = [
    ...
    public function firstName(?string $gender = null): string
    {
        ...
        if ($gender === PersonExtension::GENDER_FEMALE) {
    ...
    {
        return Helper::randomElement($this->maleFirstNames);
    }

    public function firstNameFemale(): string
    {
        return Helper::randomElement($this->femaleFirstNames);
    }

    public function lastName(): string
    {
        // FIXME replace with Helper::numberBetween?
        $i = Base::numberBetween(0, 12);
        ...
        return Helper::randomElement($this->lastNames);
    }

    public function title(?string $gender = null): string
    {
        return Helper::randomElement($this->titles);
    }
    ...
    {
        return Helper::randomElement($this->suffixes);
    }

    public function prefix(): string
    {
        return Helper::randomElement($this->prepositions);
    }
